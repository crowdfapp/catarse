...
grant select on public.mail_marketing_lists to admins, web_user;
grant select on public.mail_marketing_users to admins, web_user;
grant select on "1".mail_marketing_lists to admins, web_user;
}
  end
